...
## 依存ライブラリー一覧
```shell
PS D:\Github\workspace.jre11\CreateDummyFiles> mvn dependency:tree
Picked up JAVA_TOOL_OPTIONS: -Dfile.encoding=UTF-8 -Dsun.stdout.encoding=UTF-8 -Dsun.stderr.encoding=UTF-8
[INFO] Scanning for projects...
[INFO]
[INFO] -----------------------< tool:CreateDummyFiles >------------------------
[INFO] Building CreateDummyFiles 1.0
[INFO]   from pom.xml
[INFO] --------------------------------[ jar ]---------------------------------
[INFO]
[INFO] --- dependency:3.7.0:tree (default-cli) @ CreateDummyFiles ---
[INFO] tool:CreateDummyFiles:jar:1.0
...
[INFO] Finished at: 2026-08-30T18:09:04+09:00
[INFO] ------------------------------------------------------------------------
PS D:\Github\workspace.jre11\CreateDummyFiles>
```

## コーディング
- pom.xml
- src\main\java\tool\CreateDummyFiles.java
- src\main\java\tool\ClsAppArg.java
- src\main\java\tool\ClsProp.java
- src\main\java\tool\ClsMainProc.java
...
cd ${base_dir}
agy
「.\CreateDummyFiles\src」配下のソースに対して、スキル「source-review」を実行して
/exit
```
...
# Usage
java -jar target\CreateDummyFiles-1.0-jre11.jar -h
```
...
## リモートリポジトリを確認
- https://github.com/hide104y/CreateDummyFiles/tree/java11
